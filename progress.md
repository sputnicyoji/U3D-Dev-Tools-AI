...
>
> 最后更新: 2026-06-23 (stable registry 当前五个 ready 条目均已核对：editor-core-v0.1.0 / editor-debug-v0.1.0 / test-runner-v0.1.4 / lua-device-debug-v0.1.0 / u3d-ai-linker-v0.1.4；根目录与 linker 包内 registry snapshot 一致；remote tags 已确认；Unity 套件本次未重跑)
...
- **发布证明 (2026-06-17 / 2026-06-23 当前仓库):**
  ...
  - 本地 tag 与远端 tag 均已确认：`editor-core-v0.1.0` (`d5bf2e0`)、
    `editor-debug-v0.1.0` (`d5bf2e0`)、`test-runner-v0.1.4` (`f03b36f`)、
    `lua-device-debug-v0.1.0` (`2635d48`)、`u3d-ai-linker-v0.1.4` (`67b8e31`)。
- 实现细节与权威类型收敛见
...
- [x] u3d-ai-linker: stable registry 已发布到 `u3d-ai-linker-v0.1.4`，内嵌 snapshot 指向
      `test-runner-v0.1.4` 与 `lua-device-debug-v0.1.0`，根目录与包内 `stable.json` 一致。
