namespace Yoji.U3DAILinker.Settings
{
    ...
    public static class U3DAILinkerPackage
    {
        ...
        public const string PackageName = "com.sputnicyoji.u3d-dev-tools-ai";

        /// <summary>面板标题与 Project Settings 叶子名,与 package.json 的 "displayName" 一致。</summary>
        public const string DisplayName = "U3D Dev Tools AI";

        /// <summary>Project Settings 注册路径(SettingsScope.Project)。</summary>
        public const string SettingsPath = "Project/U3D Dev Tools AI";
