...
namespace Yoji.U3DAILinker.Tests
{
    ...
    public sealed class U3DAILinkerPackageTests
    {
        ...
        {
            Assert.AreEqual("com.sputnicyoji.u3d-dev-tools-ai", U3DAILinkerPackage.PackageName);
        }
        ...
        public void DisplayName_MatchesSettingsLeaf()
        {
            ...
            Assert.AreEqual("U3D Dev Tools AI", U3DAILinkerPackage.DisplayName);
        }

        [Test]
        public void SettingsPath_IsProjectScopedAndStable()
        {
            Assert.AreEqual("Project/U3D Dev Tools AI", U3DAILinkerPackage.SettingsPath);
        }
        ...
        public void PackageJson_NameMatchesConstant()
        {
            ...
            Assert.IsNotNull(
                info,
                "应能通过程序集定位 com.sputnicyoji.u3d-dev-tools-ai 包元数据");
