...
namespace Yoji.U3DAILinker.Tests
{
    public sealed class ManifestTransactionTests
    {
        ...
        public void OperationRecord_RoundTripsThroughJson()
        {
            var rec = new OperationRecord
            {
                ...
                DependencyChanges = new List<DependencyChange>
                {
                    new DependencyChange
                    {
                        ...
                        ChangeType = "Add",
                        OldValue = null,
                        NewValue = "https://github.com/sputnicyoji/U3D-Dev-Tools-AI.git?path=/Packages/com.sputnicyoji.u3d-dev-tools-ai#editor-debug-v1.2.0",
                    },
                },
            };
            ...
            Assert.AreEqual("com.sputnicyoji.u3d-dev-tools-ai", back.DependencyChanges[0].PackageName);
  ...
  ""enableLockFile"": true
            ...
            plan.Edits.Add(new ManifestEdit("com.sputnicyoji.u3d-dev-tools-ai", ManifestChangeType.Add, RepoUrl));
            ...
            Assert.AreEqual(RepoUrl, (string)deps["com.sputnicyoji.u3d-dev-tools-ai"]);
            // 第三方依赖与未知顶层字段原样保留
        ...
        {
            var oldUrl = "https://github.com/sputnicyoji/U3D-Dev-Tools-AI.git?path=/Packages/com.sputnicyoji.u3d-dev-tools-ai#editor-debug-v1.0.0";
            WriteManifest("{ \"dependencies\": { \"com.sputnicyoji.u3d-dev-tools-ai\": \"" + oldUrl + "\" } }");
            var tx = new ManifestTransaction(m_ManifestPath, m_StateDir);
            var plan = new ManifestPlan("opUpd", "stable", "editor-debug-v1.2.0");
            plan.Edits.Add(new ManifestEdit("com.sputnicyoji.u3d-dev-tools-ai", ManifestChangeType.Update, RepoUrl));

            var result = tx.Apply(plan, acceptConflicts: false);

            Assert.IsTrue(result.Committed, result.FailureReason);
            Assert.AreEqual(RepoUrl, (string)((JObject)ReadManifest()["dependencies"])["com.sputnicyoji.u3d-dev-tools-ai"]);
        ...
        {
            WriteManifest("{ \"dependencies\": { \"com.sputnicyoji.u3d-dev-tools-ai\": \"" + RepoUrl + "\", \"com.unity.x\": \"1.0.0\" } }");
            var tx = new ManifestTransaction(m_ManifestPath, m_StateDir);
            var plan = new ManifestPlan("opRem", "stable", null);
            plan.Edits.Add(new ManifestEdit("com.sputnicyoji.u3d-dev-tools-ai", ManifestChangeType.Remove, null));

            var result = tx.Apply(plan, acceptConflicts: false);

            Assert.IsTrue(result.Committed, result.FailureReason);
            var deps = (JObject)ReadManifest()["dependencies"];
            Assert.IsNull(deps["com.sputnicyoji.u3d-dev-tools-ai"]);
        ...
        {
            WriteManifest("{ \"dependencies\": { \"com.sputnicyoji.u3d-dev-tools-ai\": \"9.9.9\" } }");
            ...
            Assert.AreEqual("com.sputnicyoji.u3d-dev-tools-ai", result.Conflicts[0].PackageName);
        ...
        {
            WriteManifest("{ \"dependencies\": { \"com.sputnicyoji.u3d-dev-tools-ai\": \"" + RepoUrl + "\" } }");
            var tx = new ManifestTransaction(m_ManifestPath, m_StateDir);
            var plan = new ManifestPlan("opNoop", "stable", null);
            plan.Edits.Add(new ManifestEdit("com.sputnicyoji.not-installed", ManifestChangeType.Remove, null));
            plan.Edits.Add(new ManifestEdit("com.sputnicyoji.u3d-dev-tools-ai", ManifestChangeType.Remove, null));
            ...
            Assert.AreEqual("com.sputnicyoji.u3d-dev-tools-ai", result.Record.DependencyChanges[0].PackageName);
        }
