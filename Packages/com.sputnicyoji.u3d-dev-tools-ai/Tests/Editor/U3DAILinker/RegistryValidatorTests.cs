...
namespace Yoji.U3DAILinker.Registry.Tests
{
    public class RegistryValidatorTests
    {
        ...
        [Test] public void Validate_PackageNameWrongPrefix_Fails()
        {
            ...
            var ex = AssertInvalid(Doc(e), RegistryChannel.Stable);
            StringAssert.Contains("com.sputnicyoji.", ex.Message);
        }

        [Test] public void Validate_PackagePathMismatch_Fails()
        {
            var e = ValidStableEntry();
            e.PackagePath = "Packages/com.sputnicyoji.other";
            var ex = AssertInvalid(Doc(e), RegistryChannel.Stable);
        ...
        {
            var e = ValidStableEntry();
            e.PackagePath = "Packages/../com.sputnicyoji.u3d-dev-tools-ai";
        ...
        {
            var e = ValidStableEntry();
            e.PackagePath = "C:/Packages/com.sputnicyoji.u3d-dev-tools-ai";
            AssertInvalid(Doc(e), RegistryChannel.Stable);
        }
        ...
        {
            var e = ValidStableEntry();
            e.PackagePath = "https://example.com/com.sputnicyoji.u3d-dev-tools-ai";
            AssertInvalid(Doc(e), RegistryChannel.Stable);
        }
        ...
        [Test] public void Validate_DuplicateId_Fails()
        {
            ...
            b.PackageName = "com.sputnicyoji.u3d-dev-tools-ai-2";
            b.PackagePath = "Packages/com.sputnicyoji.u3d-dev-tools-ai-2";
