    ...
    public sealed class ManifestRollbackTests
    {
        ...
        public void Rollback_WhenManagedDepManuallyChanged_RefusesAndKeepsUserEdit()
        {
            ...
            File.WriteAllText(m_ManifestPath,
                "{ \"dependencies\": { \"com.unity.x\": \"1.0.0\", \"com.sputnicyoji.u3d-dev-tools-ai\": \"file:somewhere\" } }");
            ...
            // 手改值保留，未被 backup 覆盖
            Assert.AreEqual("file:somewhere", (string)Deps()["com.sputnicyoji.u3d-dev-tools-ai"]);
        }
