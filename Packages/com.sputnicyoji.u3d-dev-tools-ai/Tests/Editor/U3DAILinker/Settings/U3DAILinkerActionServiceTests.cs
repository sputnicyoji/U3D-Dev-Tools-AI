    ...
    public sealed class U3DAILinkerActionServiceTests
    {
        ...
        public void InstallOrUpdateAll_WritesManifestAndRequestsFirstDependency()
        {
            ...
            Assert.AreEqual(
                ...
                (string)deps["com.sputnicyoji.u3d-dev-tools-ai"]);
            Assert.AreEqual(
                "file:C:/Example/U3D-Dev-Tools-AI/Packages/com.sputnicyoji.u3d-dev-tools-ai",
                (string)deps["com.sputnicyoji.u3d-dev-tools-ai"]);
        ...
        public void InstallOrUpdateAll_DevChannelUsesResolvedShaInsteadOfRegistryPlaceholder()
        {
            ...
            Assert.IsTrue(result.Success, result.Error);
            var deps = (JObject)JObject.Parse(File.ReadAllText(m_ManifestPath))["dependencies"];
            StringAssert.EndsWith("#" + DevSha, (string)deps["com.sputnicyoji.u3d-dev-tools-ai"]);
            StringAssert.EndsWith("#" + DevSha, (string)deps["com.sputnicyoji.u3d-dev-tools-ai"]);
            StringAssert.DoesNotContain(PlaceholderSha, (string)deps["com.sputnicyoji.u3d-dev-tools-ai"]);
        }
