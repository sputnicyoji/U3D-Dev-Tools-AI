...
namespace Yoji.U3DAILinker.Tests
{
    ...
    {
        private const string Path = "Packages/com.sputnicyoji.u3d-dev-tools-ai";
        ...
        {
            Assert.IsTrue(ToolUrlBuilder.IsManagedUrl("file:C:/Example/U3D-Dev-Tools-AI/Packages/com.sputnicyoji.u3d-dev-tools-ai"));
        }
